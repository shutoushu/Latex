...
% The hello packet contains the following information. 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{TakahashiShuto.eps}}]{Shuto Takahashi}
...
\end{IEEEbiography}
% \vspace{-17cm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{YoshidaMasami.eps}}]{Masami Yoshida}
...
\end{IEEEbiography}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{Gallegos.eps}}]{Alberto Gallegos}
...
\end{IEEEbiography}
\vspace{-17cm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{NoguchiTaku.eps}}]{Taku Noguchi}
